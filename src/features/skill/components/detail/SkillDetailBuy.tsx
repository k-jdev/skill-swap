  ...
  return (
    <aside className="rounded-[16px] p-8 bg-white shadow-md w-full">
      <div className="flex flex-col gap-6">
        <div>
          <p className="text-muted text-sm font-semibold tracking-wider">
            EXCHANGE VALUE
          </p>
          <div className="flex items-end gap-3 mt-3">
            ...
            <p className="text-body text-lg">Credits / hour</p>
          </div>
        </div>
        ...
        <div>
          <button
            ...
            className="w-full flex items-center justify-center bg-primary hover:bg-primary-hover text-white font-bold py-4 rounded-[12px] shadow-[0_10px_20px_rgba(19,127,236,0.2)] transition-colors cursor-pointer"
            type="button"
          >
            <ExchangeIcon />
...
export function RequestModal({
  ...
  return (
    <Modal
      ...
      onClose={onClose}
    >
      <div className="flex items-center justify-between rounded-lg border border-subtle bg-primary-soft p-4">
        <div className=" flex items-center gap-3">
          <DevIcon />
          <div className="grid">
            <h4 className="text-[14px] text-slate-900 font-semibold">
              {skill?.skill_title}
            </h4>
            <p className="text-[12px] text-body font-medium">
              {" "}
        ...
        <div className="grid">
          <h4 className="text-[12px] text-slate-900 font-medium text-right">
            Value
          </h4>
          <p className="text-[14px] text-primary-active font-semibold whitespace-nowrap">
            {skill?.skill_price} credits/hour
          </p>
        </div>
      </div>
      <div className="py-6 grid">
        <h3 className="pb-2 text-[14px] text-slate-900 font-semibold">
          Message to teacher!
        </h3>
        <textarea
        ...
        ></textarea>
        <p className="pt-2 text-[12px] text-body font-medium text-right">
          0/500 characters
        </p>
      </div>
      <div className="flex items-center justify-between rounded-lg border border-subtle bg-primary-soft p-4">
        ...
        <h3 className="font-semibold text-primary-active text-2xl">12.5 credits</h3>
      </div>
      <div className="py-6 gap-2 flex  ">
        <button
          onClick={onClose}
          className="border border-primary-active rounded-full px-6 py-2.5 cursor-pointer"
        >
          <p className="font-semibold text-primary-active text-[14px] ">Cancel</p>
        </button>
        <button className="border border-primary-active rounded-full cursor-pointer px-6 py-2.5 bg-primary shadow-lg">
...
function DevIcon() {
  return (
    <div className="px-3 py-4 rounded-[4px] bg-primary/10 w-fit">
      {" "}
      <svg
        width="20"
        height="12"
